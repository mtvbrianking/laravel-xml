...
/* macros.twig */
class __TwigTemplate_62bcbfd15d603dd3e42f6ea6b6f75110fe23b7de4b59e1a456842bdfeef62ffa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_class_category_name($__categoryId__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 3
            if ((0 === twig_compare((isset($context["categoryId"]) || array_key_exists("categoryId", $context) ? $context["categoryId"] : (function () { throw new RuntimeError('Variable "categoryId" does not exist.', 3, $this->source); })()), 1))) {
echo \Wdes\phpI18nL10n\Launcher::getPlugin()->gettext("class");
            }
            // line 4
            if ((0 === twig_compare((isset($context["categoryId"]) || array_key_exists("categoryId", $context) ? $context["categoryId"] : (function () { throw new RuntimeError('Variable "categoryId" does not exist.', 4, $this->source); })()), 2))) {
echo \Wdes\phpI18nL10n\Launcher::getPlugin()->gettext("interface");
            }
            // line 5
            if ((0 === twig_compare((isset($context["categoryId"]) || array_key_exists("categoryId", $context) ? $context["categoryId"] : (function () { throw new RuntimeError('Variable "categoryId" does not exist.', 5, $this->source); })()), 3))) {
echo \Wdes\phpI18nL10n\Launcher::getPlugin()->gettext("trait");
    ...
    public function macro_namespace_link($__namespace__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo "\">";
            (((0 === twig_compare((isset($context["namespace"]) || array_key_exists("namespace", $context) ? $context["namespace"] : (function () { throw new RuntimeError('Variable "namespace" does not exist.', 9, $this->source); })()), ""))) ? (print (twig_escape_filter($this->env, Doctum\Tree::getGlobalNamespaceName(), "html", null, true))) : (print ((isset($context["namespace"]) || array_key_exists("namespace", $context) ? $context["namespace"] : (function () { throw new RuntimeError('Variable "namespace" does not exist.', 9, $this->source); })()))));
            echo "</a>";
...
";
            ...
            if ( !(((isset($context["classonly"]) || array_key_exists("classonly", $context))) ? (_twig_default_filter((isset($context["classonly"]) || array_key_exists("classonly", $context) ? $context["classonly"] : (function () { throw new RuntimeError('Variable "classonly" does not exist.', 24, $this->source); })()), false)) : (false))) {
                echo "::";
...
";
            ...
            if ( !(((isset($context["classonly"]) || array_key_exists("classonly", $context))) ? (_twig_default_filter((isset($context["classonly"]) || array_key_exists("classonly", $context) ? $context["classonly"] : (function () { throw new RuntimeError('Variable "classonly" does not exist.', 30, $this->source); })()), false)) : (false))) {
                echo "#";
    ...
    public function macro_hint_link($__hints__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 35
            $macros["__internal_303091ca8f0ca419fe686beafb467bb90c06ac3ea5ea63573f568f2d2e55dad0"] = $this;
            // line 37
            if ((isset($context["hints"]) || array_key_exists("hints", $context) ? $context["hints"] : (function () { throw new RuntimeError('Variable "hints" does not exist.', 37, $this->source); })())) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["hint"]) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["hint"], "class", [], "any", false, false, false, 39)) {
                        // line 40
                        echo twig_call_macro($macros["__internal_303091ca8f0ca419fe686beafb467bb90c06ac3ea5ea63573f568f2d2e55dad0"], "macro_class_link", [twig_get_attribute($this->env, $this->source, $context["hint"], "name", [], "any", false, false, false, 40)], 40, $context, $this->getSourceContext());
...
(isset($context["method"]) || array_key_exists("method", $context) ? $context["method"] : (function () { throw new RuntimeError('Variable "method" does not exist.', 65, $this->source); })()), "line", [], "any", false, false, false, 65));
    ...
    public function macro_method_parameters_signature($__method__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 71
            $macros["__internal_efd7c841efd948d1f00cc87e8453d348574c6428b3b68a62f7e3fe4f6bb5d9df"] = $this->loadTemplate("macros.twig", "macros.twig", 71)->unwrap();
            // line 72
            echo "(";
            // line 73
            $context['_parent'] = $context;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["parameter"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["parameter"], "hashint", [], "any", false, false, false, 74)) {
                    echo twig_call_macro($macros["__internal_efd7c841efd948d1f00cc87e8453d348574c6428b3b68a62f7e3fe4f6bb5d9df"], "macro_hint_link", [twig_get_attribute($this->env, $this->source, $context["parameter"], "hint", [], "any", false, false, false, 74)], 74, $context, $this->getSourceContext());
                    echo " ";
                }
                // line 75
    ...
    public function macro_function_parameters_signature($__method__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 83
            $macros["__internal_acbde7b315c695624057122746b054a8fa3bee13af3510aa775ad041d18a0405"] = $this->loadTemplate("macros.twig", "macros.twig", 83)->unwrap();
            // line 84
            echo "(";
            // line 85
            $context['_parent'] = $context;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["parameter"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["parameter"], "hashint", [], "any", false, false, false, 86)) {
                    echo twig_call_macro($macros["__internal_acbde7b315c695624057122746b054a8fa3bee13af3510aa775ad041d18a0405"], "macro_hint_link", [twig_get_attribute($this->env, $this->source, $context["parameter"], "hint", [], "any", false, false, false, 86)], 86, $context, $this->getSourceContext());
                    echo " ";
                }
                // line 87
    ...
    public function macro_render_classes($__classes__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 95
            $macros["__internal_69e7951aeb37ddd079f6e7f152fb1cb610fce103041cbfd7113991b9af367777"] = $this;
            // line 96
            echo "
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["class"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["class"], "isInterface", [], "any", false, false, false, 101)) {
                    // line 102
                    echo "                        <em>";
                    echo twig_call_macro($macros["__internal_69e7951aeb37ddd079f6e7f152fb1cb610fce103041cbfd7113991b9af367777"], "macro_class_link", [$context["class"], true], 102, $context, $this->getSourceContext());
                    echo "</em>
                    ";
                } else {
                    // line 104
                    echo twig_call_macro($macros["__internal_69e7951aeb37ddd079f6e7f152fb1cb610fce103041cbfd7113991b9af367777"], "macro_class_link", [$context["class"], true], 104, $context, $this->getSourceContext());
                }
                // line 106
                echo twig_call_macro($macros["__internal_69e7951aeb37ddd079f6e7f152fb1cb610fce103041cbfd7113991b9af367777"], "macro_deprecated", [$context["class"]], 106, $context, $this->getSourceContext());
                // line 107
                echo "</div>
                <div class=\"col-md-6\">";
                // line 109
...
echo \Wdes\phpI18nL10n\Launcher::getPlugin()->gettext("deprecated");
    ...
    public function macro_deprecations($__reflection__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 133
            echo "    ";
            $macros["__internal_bdb9aeb8795ff6e3f38e4a15332194ecd124d2f51ef71a33e4fcf8a638763759"] = $this;
            // line 134
            echo "
    ";
            // line 135
            ...
            ";
                // line 137
                echo twig_call_macro($macros["__internal_bdb9aeb8795ff6e3f38e4a15332194ecd124d2f51ef71a33e4fcf8a638763759"], "macro_deprecated", [(isset($context["reflection"]) || array_key_exists("reflection", $context) ? $context["reflection"] : (function () { throw new RuntimeError('Variable "reflection" does not exist.', 137, $this->source); })())], 137, $context, $this->getSourceContext());
                echo "
            ";
                // line 138
                $context['_parent'] = $context;
...
echo \Wdes\phpI18nL10n\Launcher::getPlugin()->gettext("internal");
    ...
    public function macro_todo($__reflection__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 163
            echo "        ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["project"]) || array_key_exists("project", $context) ? $context["project"] : (function () { throw new RuntimeError('Variable "project" does not exist.', 163, $this->source); })()), "config", [0 => "insert_todos"], "method", false, false, false, 163), true))) {
                // line 164
                echo "            ";
...
echo \Wdes\phpI18nL10n\Launcher::getPlugin()->gettext("todo");
    ...
    public function macro_todos($__reflection__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 169
            echo "        ";
            $macros["__internal_9b9060e38f158ee5561864801cc5d4608859a2afe3556e09eebe122884808823"] = $this;
            // line 170
            echo "
        ";
            // line 171
            if (twig_get_attribute($this->env, $this->source, (isset($context["reflection"]) || array_key_exists("reflection", $context) ? $context["reflection"] : (function () { throw new RuntimeError('Variable "reflection" does not exist.', 171, $this->source); })()), "todo", [], "any", false, false, false, 171)) {
                ...
                ";
                // line 173
                echo twig_call_macro($macros["__internal_9b9060e38f158ee5561864801cc5d4608859a2afe3556e09eebe122884808823"], "macro_todo", [(isset($context["reflection"]) || array_key_exists("reflection", $context) ? $context["reflection"] : (function () { throw new RuntimeError('Variable "reflection" does not exist.', 173, $this->source); })())], 173, $context, $this->getSourceContext());
                echo "
                ";
                // line 174
                $context['_parent'] = $context;
...
{% macro todos(reflection) %}
        ...
        {% endif %}
{% endmacro %}
", "macros.twig", "/home/runner/work/laravel-xml/laravel-xml/vendor/code-lts/doctum/src/Resources/themes/default/macros.twig");
    }
}
